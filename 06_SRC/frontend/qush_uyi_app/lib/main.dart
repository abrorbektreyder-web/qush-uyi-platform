    ...
    setState(() {
      _filteredBirds = _birds.where((bird) {
        ...
        if (_selectedCategory != "Hammasi" &&
            bird["category"] != _selectedCategory) return false;
        ...
        if (query.isNotEmpty) {
          bool matchesBreed =
              bird["breed"].toString().toLowerCase().contains(query);
          bool matchesCategory =
              bird["category"].toString().toLowerCase().contains(query);
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const VerifiedBirdsPage()));
                },
                child: Container(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text("Tasdiqlangan Qushlar",
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 16)),
                            Text("Faqat ishonchli sotuvchilardan",
                                style: TextStyle(
                ...
                children: [
                  ...
                  FilterChip(
                    ...
                    labelStyle: TextStyle(
                        color: _onlyVerified ? Colors.white : Colors.black),
                  ),
                ],
              ),
            ],
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Container(
                          ...
                          child: const Text("BAND QILINGAN",
                              style: TextStyle(
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 20)),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                          backgroundColor: isHeld ? Colors.grey : null),
                      onPressed: isHeld
                          ? null
                          : () {
                              showModalBottomSheet(
                      ...
                      child: Text(isHeld
                          ? "SOTILGAN / BAND QILINGAN"
                          : "SOTIB OLISH (XAVFSIZ TO'LOV)"),
                    ),
                  ),
                  if (isHeld) ...[
                      ...
                      child: OutlinedButton.icon(
                        onPressed: () {
                          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                              content: Text(
                                  "Nizo (Spor) ochildi! Admin ko'rib chiqadi.")));
                        },
                        icon: const Icon(Icons.warning, color: Colors.red),
                        label: const Text("NIZO OCHISH (DISPUTE)",
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: const Center(
              child: Icon(Icons.qr_code_2,
                  size: 150, color: Colors.black), // Mock QR
            ),
          ),
          const SizedBox(height: 24),
          const Row(
          ...
          const SizedBox(height: 8),
          const Text(
              "Ushbu qush Qush Uyi platformasi tomonidan tekshirilgan va ma'lumotlari to'g'ri deb topilgan.",
...
class _AddListingPageState extends State<AddListingPage> {
  ...
  void _pickMedia() {
    ...
    setState(() {
      if (_mockSelectedFiles.length < 5) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text("Maksimal 5 ta fayl yuklash mumkin!")));
      }
    });
  }
  ...
  void _pickDocument() {
    ...
    setState(() {
      _attachedDocument =
          "bird_passport_${DateTime.now().millisecondsSinceEpoch}.pdf";
    });
  }
            ...
            child: Column(
              ...
              children: [
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: const DecorationImage(
                                image: NetworkImage(
                                    "https://via.placeholder.com/100"), // Mock Preview
                                fit: BoxFit.cover)),
                        child: Align(
                ...
                DropdownButtonFormField<String>(
                  decoration: const InputDecoration(
                      labelText: "Kategoriya", border: OutlineInputBorder()),
                ...
                const TextField(
                  decoration: InputDecoration(
                      labelText: "Paroda (Zoti)", border: OutlineInputBorder()),
                ),
                const SizedBox(height: 16),
                const TextField(
                  decoration: InputDecoration(
                ...
                DropdownButtonFormField<String>(
                  decoration: const InputDecoration(
                      labelText: "Sizning Hududingiz (Info uchun)",
                      border: OutlineInputBorder()),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(8),
                    color:
                        Colors.blue[50], // Light blue to highlight importance
                  ),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text("Hujjat yuklash (Ixtiyoriy)",
                          style: TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 14)),
                      const SizedBox(height: 4),
                      const Text(
                          "Pasport yoki Vet-ma'lumotnoma yuklasangiz, 'Tasdiqlangan' belgisini olasiz.",
                          style: TextStyle(fontSize: 12, color: Colors.grey)),
                      const SizedBox(height: 8),
                    ...
                    onPressed: () {
                      if (_mockSelectedFiles.isEmpty) {
                        ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content: Text("Kamida 1 ta rasm yuklang!")));
                        return;
                      }
                      Navigator.pop(context);
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          const Text("Xavfsizlik va Aloqa",
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 12),
          SwitchListTile(
            title: const Text("Telefon raqamni ko'rsatish"),
            subtitle:
                const Text("Boshqa foydalanuvchilar raqamingizni ko'ra oladi"),
            value: true,
            onChanged: (val) {},
            activeColor: Colors.blue,
          ),
          SwitchListTile(
            title: const Text("Telegram orqali bog'lanish"),
            subtitle: const Text("E'loningizda Telegram tugmasi chiqadi"),
            value: true,
            onChanged: (val) {},
            activeColor: Colors.blue,
          ),
          ...
          OutlinedButton.icon(
            onPressed: () {
              // Simulate Telegram Linking
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                  content: Text("Telegram Botga yo'naltirilmoqda...")));
            },
            icon: const Icon(Icons.telegram, color: Colors.blue),
            label: const Text("TELEGRAMNI ULASH"),
            style: OutlinedButton.styleFrom(
              ...
              onPressed: () {
                if (_nameController.text.isNotEmpty &&
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                        content: Text(
                            "Profil va Sozlamalar saqlandi! Xush kelibsiz.")),
                  );
                }
              },
              style: ElevatedButton.styleFrom(
...
class _PaymentModalState extends State<PaymentModal> {
      ...
      child: Column(
        ...
        children: [
          ...
          if (_isLoading)
            ...
            _buildPaymentMethod("Click", "assets/click_logo.png", Colors.blue),
            const SizedBox(height: 12),
            _buildPaymentMethod("Payme", "assets/payme_logo.png", Colors.teal),
          ]
        ],
      ),
    );
  ...
  Widget _buildPaymentMethod(String name, String asset, Color color) {
    return InkWell(
      onTap: () => _processPayment(name.toLowerCase()),
      child: Container(
        ...
        child: Row(
          children: [
            Icon(Icons.credit_card, color: color, size: 30),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 24),
              const Text("To'lov Muvaffaqiyatli!",
                  style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
              const SizedBox(height: 16),
              const Text(
                "Sizning pulingiz Xavfsiz Hisobda (Escrow) muzlatildi. Qushni qabul qilib olganingizdan so'ng, pul sotuvchiga o'tkaziladi.",
                textAlign: TextAlign.center,
...
class VerifiedBirdsPage extends StatelessWidget {
  const VerifiedBirdsPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Tasdiqlangan Qushlar")),
      body: const Center(
          child: Text("Tasdiqlangan qushlar ro'yxati (Tez orada...)")),
    );
  }
}
